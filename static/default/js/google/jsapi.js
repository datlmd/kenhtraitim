...
if (!window['google']['loader']) {
    ...
    (function() {
        var d=void 0,g=!0,h=null,k=!1,l=encodeURIComponent,m=window,n=document;
        function p(a,b){
            return a.load=b
            }
            var r="push",s="replace",t="charAt",v="indexOf",w="ServiceBase",x="name",y="getTime",z="length",A="prototype",B="setTimeout",C="loader",D="substring",E="join",F="toLowerCase";
        function G(a){
        ...
        function L(a,b){
        for(var c=a.split(/\./),e=m,f=0;f<c[z]-1;f++)e[c[f]]||(e[c[f]]={}),e=e[c[f]];
        e[c[c[z]-1]]=b
        }
        function aa(a,b,c){
        a[b]=c
        ...
        p(google,function(a,b,c){
            ...
            if(a instanceof Array||a&&"object"==typeof a&&"function"==typeof a[E]&&"function"==typeof a.reverse)for(var j=0;j<a[z];j++)e(a[j]);else e(a);
            if(a=O[":"+f]){
                c&&(!c.language&&c.locale)&&(c.language=c.locale);
                c&&"string"==typeof c.callback&&(j=c.callback,j.match(/^[[\]A-Za-z0-9._]+$/)&&(j=m.eval(j),c.callback=
                    j));
                if((j=c&&c.callback!=h)&&!a.s(b))throw K("Module: '"+f+"' must be loaded before DOM onLoad!");
    ...
    google[C].O=function(){
        ...
        "complete"==a.readyState&&(a.onreadystatechange=h,a.parentNode.removeChild(a),S())
        };
    ...
    function S(){
        ...
        if(c){
            var e;
            "script"==a?(e=n.createElement("script"),e.type="text/javascript",e.src=b):"css"==a&&(e=n.createElement("link"),e.type="text/css",e.href=b,e.rel="stylesheet");
            (a=n.getElementsByTagName("head")[0])||(a=n.body.parentNode.appendChild(n.createElement("head")));
            a.appendChild(e)
    ...
    google[C].Q=function(a){
        if((a=a.specs)&&a[z])for(var b=0;b<a[z];++b){
            var c=a[b];
            "string"==typeof c?O[":"+c]=new V(c):(c=new W(c[x],c.baseSpec,c.customSpecs),O[":"+c[x]]=c)
            }
        };
...
google[C].a.H="//www.google.com/cse/style/look/bubblegum.css";
N(google[C].a,"BUBBLEGUM",google[C].a.H);
google[C].a.J="//www.google.com/cse/style/look/greensky.css";
N(google[C].a,"GREENSKY",google[C].a.J);
google[C].a.I="//www.google.com/cse/style/look/espresso.css";
N(google[C].a,"ESPRESSO",google[C].a.I);
google[C].a.L="//www.google.com/cse/style/look/shiny.css";
N(google[C].a,"SHINY",google[C].a.L);
google[C].a.K="//www.google.com/cse/style/look/minimalist.css";
N(google[C].a,"MINIMALIST",google[C].a.K);
google[C].a.M="//www.google.com/cse/style/look/v2/default.css";
...
V[A].g=function(a,b){
    var c="";
    b!=d&&(b.language!=d&&(c+="&hl="+l(b.language)),b.nocss!=d&&(c+="&output="+l("nocss="+b.nocss)),b.nooldnames!=d&&(c+="&nooldnames="+l(b.nooldnames)),b.packages!=d&&(c+="&packages="+l(b.packages)),b.callback!=h&&(c+="&async=2"),b.style!=d&&(c+="&style="+l(b.style)),b.noexp!=d&&(c+="&noexp=true"),b.other_params!=d&&(c+="&"+b.other_params));
    if(!this.j){
...
V[A].t=function(a){
    ...
    if(b)if("string"==typeof b)c=[a.packages];
        ...
        c=[];
        for(a=0;a<b[z];a++)"string"==typeof b[a]&&c[r](b[a][s](/^\s*|\s*$/,"")[F]())
            }
            c||(c=["default"]);
    b=[];
...
p(V[A],function(a,b){
    ...
    for(var j=[],q=c[z]-1;0<=q;q--){
        var u=c[q];
        e&&f.A(u);
        if(this.e[":"+u])c.splice(q,1),e&&this.f[":"+u][r](f);else j[r](u)
            }
            if(c[z]){
        b&&b.packages&&(b.packages=c.sort()[E](","));
        for(q=0;q<j[z];q++)u=j[q],this.f[":"+u]=[],e&&this.f[":"+u][r](f);
        if(!b&&P[":"+this.b]!=h&&P[":"+this.b].versions[":"+a]!=h&&!google[C].AdditionalParams&&this.j){
            c=P[":"+this.b];
            google[this.b]=google[this.b]||{};
            
            for(var U in c.properties)U&&":"==
                U[t](0)&&(google[this.b][U[D](1)]=c.properties[U]);google[C].d("script",google[C][w]+c.path+c.js,e);
            c.css&&google[C].d("css",google[C][w]+c.path+c.css,e)
            }else(!b||!b.autoloaded)&&google[C].d("script",this.g(a,b),e);
        this.j&&(this.j=k,this.c=(new Date)[y](),1!=this.c%100&&(this.c=-1));
...
W[A].F=function(a,b,c){
    ...
    if(c!=h)for(var f in c)a.params[f]?e+="&"+Y(a.params[f],c[f]):"other_params"==f?e+="&"+c[f]:"base_domain"==f&&(b="http://"+c[f]+a.uri[D](a.uri[v]("/",7)));google[this[x]]={};
    -1==b[v]("?")&&e&&(e="?"+e[D](1));
    return b+e
    };
...
var ea=k,Z=[],fa=(new Date)[y](),ha=function(){
    ...
    ha();
    if(!google[C].Secure&&(!google[C].Options||google[C].Options.csi===k)){
    ...
    c?ia([a],[b]):(ha(),Z[r]("r"+Z[z]+"="+l(a+(b?"|"+b:""))),m[B](ga,5<Z[z]?0:15E3))
    },ga=function(){
    if(Z[z]){
        var a=
        google[C][w];
        0==a[v]("http:")&&(a=a[s](/^http:/,"https:"));
        $(a+"/stats?"+Z[E]("&")+"&nc="+(new Date)[y]()+"_"+((new Date)[y]()-fa));
        Z.length=0
        }
    },$=function(a){
    var b=new Image,c=$.G++;
...
google.loader.rfm({
    ":search":{
        ...
        "path":"/api/search/1.0/8c68537a8c14de310f268bd7f81c9c67/",
        "js":"default+en.I.js",
        "css":"default+en.css",
        "properties":{
            ":JSHash":"8c68537a8c14de310f268bd7f81c9c67",
            ":NoOldNames":false,
            ":Version":"1.0"
        }
    },
