...
class Admin_article_upload extends MY_Controller
{
    ...
    */
    public function avatar()
    {
    	...
    	// upload
    	$upload = upload_file('file_name_avatar', 'images', config_item('articles_avatar_type'), config_item('articles_avatar_size'));
    	...
    	} else
    	{
    		...
    		create_thumb($file['full_path'], config_item('articles_avatar_resize_width'), config_item('articles_avatar_resize_height'));
