...
define('VNG_SESSION_HOST','10.30.46.99');	// ip vng session, passport cung cap real
...
//define('URL_LOGOUT','http://sso2.zing.vn/?method=logout&return=');
define('URL_RETURN_LOGOUT','');
//define('URL_VNG_SSO','http://ssolocal.zing.vn/index.php');//(DEV)
//define('URL_VNG_SSO','http://sso2.zing.vn/index.php');//dev
