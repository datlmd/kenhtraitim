<?php /* Smarty version Smarty-3.1.1, created on 2015-03-13 15:44:53
         compiled from "application/views/default\layouts\_modal.inc.tpl" */ ?>
<?php /*%%SmartyHeaderCode:159845502a3852f0420-10441986%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0876163b1e9d3061b7e1b998912180fbe6a8159' => 
    array (
      0 => 'application/views/default\\layouts\\_modal.inc.tpl',
      1 => 1425626154,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '159845502a3852f0420-10441986',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5502a385424e2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5502a385424e2')) {function content_5502a385424e2($_smarty_tpl) {?><!-- Modal -->
<div id="fb-root"></div>
<div id="popup_wrapper">
    <?php if (!$_smarty_tpl->tpl_vars['this']->value->session->userdata('user_id')){?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="margin:10px;">
                        <iframe width="100%" height="100%" frameborder="0" scrolling="no" allowtransparency="true" src="<?php echo get_zingme_sso_url();?>
">
                        </iframe>
                    </div>
                </div>
...
<script type="text/javascript">
    var facebook_app_id = '<?php echo config_item('fb_appid');?>
';
    var google_client_id = '<?php echo config_item('gg_clientid');?>
';
    var google_api_key = '<?php echo config_item('gg_clientsecret');?>
';
    var base_url_zing = '<?php echo base_url_zing();?>
';
    var static_frontend_zing = '<?php echo base_url_zing();?>
';
    ...
    function show_loading() {
        $('#login_panel').append('<div class="login_loading login-loading"></div><div class="login_loading login-loading-otr"><img src="<?php echo static_base();?>
images/loading.gif" alt="" /></div>');
    ...
    $(function () {
        ...
        $('.login-zing').on('click', function () {
            $('#popup-login').modal('hide');
            $("#zing-popup .modal-body").html('<iframe width="100%" height="100%" frameborder="0" scrolling="no" allowtransparency="true" src="<?php echo get_zingme_sso_url();?>
"></iframe>');
            resize_popup();
...
<script type="text/javascript" src="<?php echo static_base_cache();?>
/frontend/js/utilities.js"></script>
<script type="text/javascript" src="<?php echo static_base_cache();?>
js/bootstrap.min.js"></script>
<link href="<?php echo static_base_cache();?>
css/bootstrap.css" rel="stylesheet" type="text/css">
<link href="<?php echo static_base_cache();?>
css/modal.css" rel="stylesheet" type="text/css">
<link href="<?php echo static_base_cache();?>
css/reset.css" rel="stylesheet" type="text/css">
<script src="<?php echo static_frontend_cache();?>
js/waypoints.min.js"></script>
<script src="<?php echo static_frontend_cache();?>
js/jquery.easing.1.3.js"></script><?php }} ?>