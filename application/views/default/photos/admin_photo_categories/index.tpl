...
<div class="heading">
    ...
    <div class=buttons>                
        <a href="{base_url('photos/admin_photo_categories/add')}" class="button"><span>{lang('Add')}</span></a>
...
<div class="content">
    ...
    <form action="{base_url('photos/admin_photo_categories/delete')}" class="JsDeleteForm" method="post">
