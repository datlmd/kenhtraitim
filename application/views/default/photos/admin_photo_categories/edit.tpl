...
<div class="heading">
    ...
    <div class=buttons>                
        <a href="{base_url()}photos/admin_photo_albums/add/{$edit_module.id}" class="button"><span>{lang('Add Album')}</span></a>
    </div>
</div>
        ...
        <table class="list">
            <tbody>            
	            ...
	            <tr>
	                ...
	                <td class="left"><input type="text" name="counter_album" value="{$edit_module.counter_album}" /></td>
	            </tr>
	            <tr>
