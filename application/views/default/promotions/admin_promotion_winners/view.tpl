...
<div class="heading">
    <h1>{lang('View Admin promotion winners')}</h1>
    ...
    <table class="list">
        <tbody>
            ...
            <tr>
                ...
                <td class="left">{pg_field_value($data_view->modified, 'TEXT')}</td>
            </tr>
            ...
            <tr>
                <td class="left head">{get_label('is_received')}</td>
                <td class="left">{pg_field_value($data_view->is_received, 'TEXT')}</td>
            </tr>

            <tr>
                <td class="left head">{get_label('received_date')}</td>
                <td class="left">{pg_field_value($data_view->received_date, 'DATETIME')}</td>
            </tr>

            <tr>
                <td class="left head">{get_label('is_confirm')}</td>
                <td class="left">{pg_field_value($data_view->is_confirm, 'TEXT')}</td>
            </tr>

            <tr>
                <td class="left head">{get_label('confirm_date')}</td>
                <td class="left">{pg_field_value($data_view->confirm_date, 'DATETIME')}</td>
            </tr>

            <tr>
                <td class="left head">{get_label('modified_user')}</td>
                <td class="left">{pg_field_value($data_view->modified_user, 'TEXT')}</td>
            </tr>
