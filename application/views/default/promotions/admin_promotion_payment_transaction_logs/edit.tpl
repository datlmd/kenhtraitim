...
<div class="heading">
    <h1>{lang('Edit Admin promotion payment transaction logs')}</h1>
    ...
    <form action="" method="post" id="FormEditPromotions">
        ...
        <table class="list">
            <tbody>            
                ...
                <tr>
                    <td class="left">{get_label('modifed')}</td>
                    <td class="left"><input type="text" name="modifed" value="{$data_edit->modifed}" /></td>
                </tr>
