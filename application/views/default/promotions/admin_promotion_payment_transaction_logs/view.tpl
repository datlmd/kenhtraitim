...
<div class="heading">
    <h1>{lang('View Admin promotion payment transaction logs')}</h1>
...
<div class="content">
    <table class="list">
        <tbody>
            ...
            <tr>
                <td class="left head">{get_label('modifed')}</td>
                <td class="left">{pg_field_value($data_view->modifed, 'DATETIME')}</td>
            </tr>
