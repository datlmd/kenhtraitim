...
<li>
    ...
    <div class="basic_right_li">
        <input type="text" id="basic_name" name="name" value="{$post.name}">
...
<li>
    ...
    <div class="basic_right_li">
        <input type="text" id="basic_email" name="email" value="{$post.email}">

        <div class="basic_register_error" id="basic_email_error">
            {form_error('email')}
        </div>
    </div>
</li>
...
<li>
    ...
    <div class="basic_right_li">
        <input type="radio" name="sex" value="male" style="float: left; width: 15px;" checked><span
                style="float: left; width: 40px; padding-top: 3px;">Nam</span>
        <input type="radio" name="sex" value="female" style="float: left;width: 15px;"><span
...
<li>
    ...
    <div class="basic_right_li">
        <input type="text" id="basic_phone" name="phone" value="{$post.phone}">
...
<li>
    ...
    <div class="basic_right_li">
        <input type="text" id="basic_address" name="address" value="{$post.address}">
...
$(document).ready(function () {
    ...
    $('#basic_day').val({$post.dName1});
    $('#basic_month').val({$post.mName1});
    $('#basic_year').val({$post.yName1});
    $('input:radio[name=sex]').filter('[value={$post.sex}]').attr('checked', true);
    ...
    //Check address
//    $('#basic_address').blur(function () {
//        check_address();
//    });
//    $('#basic_address').keyup(function () {
...
function validateForm() {
    ...
    if (check_username_Vietnamese() == true) {
        flag_submit++;
    }
    if (check_password() == true) {
        flag_submit++;
    }
    if (check_password_Vietnamese() == true) {
        flag_submit++;
    }
