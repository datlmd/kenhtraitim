 ...
 * 
 * Admin Survey Question Type Manager
 * 
 * @package PenguinFW
 * @subpackage surveys
 * @version 1.0.0
...
<div class="heading">
    <h1>{lang('Survey Question Type manager')}</h1>
    
    <div class=buttons>                
        <a href="{base_url('surveys/admin_survey_question_types/add')}" class="button"><span>{lang('Add')}</span></a>
...
<div class="content">
    ...
    <form action="{base_url('surveys/admin_survey_question_types/delete')}" class="JsDeleteForm" method="post">
